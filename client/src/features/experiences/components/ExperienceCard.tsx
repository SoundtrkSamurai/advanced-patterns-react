  ...
  return (
    <Card className="overflow-hidden p-0">
      ...
      <div className="w-full space-y-4 p-4">
        ...
        <ExperienceCardUserMetricButtons experience={experience} />
      </div>
    </Card>
  );
};
...
type ExperienceCardUserMetricButtonsProps = Pick<
  ExperienceCardProps,
  "experience"
>;

function ExperienceCardUserMetricButtons({
  experience,
}: ExperienceCardUserMetricButtonsProps) {
  return (
    <div className="flex items-center gap-2">
